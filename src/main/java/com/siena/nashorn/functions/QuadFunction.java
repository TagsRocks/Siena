...
/**
 * Represents a function that takes four arguments.
 * @author Dylan Vicchiarell
 ...
 */
@FunctionalInterface
public interface QuadFunction<S, U, V, W, T> {
     ...
     */
    T call(S first_argument, U second_argument, V third_argument, W fourth_argument);
}
